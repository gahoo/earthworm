  ...
  <div class="relative flex w-full flex-col p-4">
    ...
    <template v-else>
      <div class="mb-4 flex items-center justify-between">
        <h2 class="text-3xl font-bold dark:border-gray-600">
        ...
        >
          ...
          >
            <div class="group relative">
              ...
              <div
                v-if="isCreator"
                class="absolute bottom-2 right-2 z-10 flex space-x-2"
              >
                <button
                  class="btn btn-primary btn-xs shadow-md"
                  @click.stop="openEditModal(course)"
                >
                  Edit
                </button>
                <button
                  class="btn btn-error btn-xs shadow-md"
        ...
        <UCard>
          ...
          <div class="space-y-4">
            <div class="form-control">
              ...
              <label class="label"
                ><span class="label-text-alt">Hold Ctrl/Cmd to select multiple</span></label
              >
            </div>

            <div class="form-control">
              <label class="label"
                ><span class="label-text">Prompt / Instructions (Optional)</span></label
              >
              <textarea
                v-model="aiPrompt"
                placeholder="e.g. Generate 3 short reading comprehension lessons about history."
      ...
      >
        <UCard>
          <h3 class="mb-4 text-lg font-bold">{{ isEditing ? "Edit Course" : "Add New Course" }}</h3>
          <div class="space-y-4">
            <div>
            ...
            <div>
              <label class="label"
                ><span class="label-text">Content / Words (JSON/Text)</span></label
              >
              <textarea
...
import { createCourse, deleteCourse, generateCourseViaAI, updateCourse } from "~/api/course-pack";
